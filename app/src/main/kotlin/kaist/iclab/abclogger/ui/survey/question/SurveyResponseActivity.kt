...
import kaist.iclab.abclogger.InvalidContentException
...
class SurveyResponseActivity: BaseAppCompatActivity(), SensorEventListener {
    ...
    private fun setupLiveData() {
        ...
        initLoadState.observe(this, Observer {
            ...
            scroll_view.visibility = if (it?.status == LoadStatus.FAILED) View.GONE else View.VISIBLE
    ...
    companion object {
        private val EXTRA_SURVEY_ENTITY_ID = "${SurveyResponseActivity::class.java}.EXTRA_SURVEY_ENTITY_ID"
        private val EXTRA_SURVEY_TITLE = "${SurveyResponseActivity::class.java}.EXTRA_SURVEY_TITLE"
        private val EXTRA_SURVEY_MESSAGE = "${SurveyResponseActivity::class.java}.EXTRA_SURVEY_MESSAGE"
        private val EXTRA_SURVEY_DELIVERED_TIME = "${SurveyResponseActivity::class.java}.EXTRA_SURVEY_DELIVERED_TIME"
        private val EXTRA_SURVEY_IS_ENABLE_TO_RESPOND = "${SurveyResponseActivity::class.java}.EXTRA_SURVEY_IS_ENABLE_TO_RESPOND"
        private val EXTRA_SHOW_FROM_SURVEY_LIST = "${SurveyResponseActivity::class.java}.EXTRA_SHOW_FROM_SURVEY_LIST"

        fun newIntent(context: Context, id: Long, showFromList: Boolean = true) : Intent = Intent(context, SurveyResponseActivity::class.java)
            .putExtra(EXTRA_SURVEY_ENTITY_ID, id)
