...
@FlowPreview
class ConfigGeneralFragment : BaseViewModelFragment<FragmentConfigBinding, ConfigViewModel>(), ConfigDataAdapter.OnItemClickListener {
    ...
    override fun afterViewCreated(viewBinding: FragmentConfigBinding) {
        ...
        lifecycleScope.launchWhenResumed {
            viewModel.config.collectLatest { state ->
